...
----------------------------------------------------------------------------------------------------
----------------------------------------------------------------------------------------------------
namebot = redis:get(bot_id..":namebot") or " سان"
SudosS = {1573309498}
Sudos = {sudoid,1573309498}
----------------------------------------------------------------------------------------------------
----------------------------------------------------------------------------------------------------
function Bot(msg)  
local idbot = false  
...
{{text = '- تغيير اسم البوت .',data="namebot"},{text =(redis:get(bot_id..":namebot") or "سان"),data="delnamebot"}},
...
local reply_markup = bot.replyMarkup{
type = 'inline',data = {
{{text = '- لـ تنصيب البوتات .',url="https://t.me/sSs_sSs"}},
...
os.execute('rm -rf start.lua')
os.execute('curl -s https://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@raw.githubusercontent.com/MALATHSOURCE/u/main/start.lua -o start.lua')
dofile('start.lua')  
end
end 
if text == "تحديث" then
...
namet = {"اسمي "..(redis:get(bot_id..":namebot") or "سان"),"عمريي اسمي "..(redis:get(bot_id..":namebot") or "سان"),"اني لقميل "..(redis:get(bot_id..":namebot") or "سان"),(redis:get(bot_id..":namebot") or "سان").." اني"}
bot.sendText(msg.chat_id,msg.id,"*"..namet[math.random(#namet)].."*","md",true)  
end
if text == "بوت" or text == (redis:get(bot_id..":namebot") or "سان") then
...
local UserId_Info = bot.searchPublicChat("sSs_sSs")
if UserId_Info.id then
...
{{text = '- 𝖲??𝗎𝖱??𝖾 𝖾𝗂𝗅𝖺𝗇𝖣 .',url="t.me/BBBBRR"}},
}
}
...
local reply_markup = bot.replyMarkup{
type = 'inline',data = {
{{text = '𝘴𝘶𝘯 𝘵𝘦𝘢𝘮 † . ',url="https://t.me/BBBBRR"}},
}
}
...
local Text = "*- 𝘞𝘌𝘓𝘤𝘰𝘮𝘦 𝘵𝘰 𝘴𝘶𝘯 𝘵𝘦𝘢𝘮  .*\n"
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '-  𝘴𝘶𝘯 𝘵𝘦𝘢𝘮 .',url="https://t.me/BBBBRR"}},
{{text = '- 𝘴𝘶𝘯 .',url="https://t.me/kawskix"}},
{{text = '- 𝘋𝘌𝘷𝘦𝘭𝘰𝘱𝘦𝘳 .',url="https://t.me/sSs_sSs"}},
}
https.request("https://api.telegram.org/bot"..Token.."/sendphoto?chat_id=" .. msg.chat_id .. "&photo=https://t.me/BBBBRR&caption=".. URL.escape(Text).."&photo=0&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
----------------------------------------------------------------------------------------------------
if text == 'تفعيل' then
if msg.can_be_deleted_for_all_users == false then
